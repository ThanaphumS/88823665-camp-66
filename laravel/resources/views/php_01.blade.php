        ...
        <div class="container mt-5">
            <form method="post" action="{{url('/mycontroller')}}">
                ...
                <div class="mb-3">
                    ...
                    <input name="myinput" type="number" class="form-control" id="exampleFormControlInput1" required>
                </div>
                <div class="mb-3">
            ...
            <div class="mb-3">
                <?php if(isset($_REQUEST['myinput'])){
                    $myvar = $_REQUEST['myinput'];?>
                    <h2>สูตรคูณแม่ <?php echo isset($myvar) ? $myvar : ""; ?></h2>
                <?php
                    for ($i=1; $i <= 12; $i++) {
                ?>
                <div class="row">
